...
export default function DashboardKpiGrid({
  ...
  function openOutOfWarrantyTable() { setMoreSubTab?.("out_of_warranty"); }
    ...
    <div>
      ...
      {statsLoading ? (
        ...
        <div className="grid grid-cols-2 gap-2.5">
          ...
          <KpiCard
            title={"Out of\nWarranty"}
            value={customerStats?.outOfWarrantyCount ?? 0}
            body="No warranty, no AMC"
            icon={
              <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
            ...
            onClick={openOutOfWarrantyTable}
            enabled={isLive("customers")}
          />
