...
// This table's free-text date columns (hoc_date, amc_warranty_due, ...) are
// hand-maintained in DD/MM/YYYY — matches every real row already in the
// sheet/DB, not the ISO format used elsewhere in the app.
export function formatCustomerDateDDMMYYYY(date) {
