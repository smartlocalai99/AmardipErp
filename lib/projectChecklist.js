...
// Maps PROJECT_CHECKLIST_PHASES by index to PhaseIcon's phase keys — same
// six phases, same order, just two different naming schemes to reconcile.
export const PHASE_ICON_KEYS = ["site", "rails", "roping", "cabin", "wiring", "commissioning"];
