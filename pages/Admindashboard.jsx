...
function AdmindashboardShell({ user }) {
    ...
    const canDeleteJobs = canDeleteJobAssignment(user);
                                                        ...
                                                        <div key={u.id} className="rounded-2xl border border-slate-200/80 bg-white p-3.5 flex items-center justify-between">
                                                            ...
                                                            <div className="flex items-center gap-2 shrink-0">
                                                                {u.phone && (
                                                                    <a
                                                                        href={`tel:${u.phone}`}
                                                                        className="h-8.5 w-8.5 rounded-lg bg-[#0a649d] hover:bg-[#085282] text-white flex items-center justify-center active:scale-95 transition"
                                                                        title="Call"
                                                                    >
                    ...
                    <div className="w-full max-w-sm bg-white rounded-3xl border border-slate-200 shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200">
                        ...
                        <div className="p-5 space-y-4 max-h-[70vh] overflow-y-auto">
                            ...
                            <div className="grid grid-cols-2 gap-2.5 border-t border-slate-100 pt-4">
                                ...
                                {!selectedComplaintIsTerminal && canDeleteJobs && (
                                    <button
                                        type="button"
