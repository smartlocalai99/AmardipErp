                ...
                <FieldShell>
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <input
                      ...
                      required
                      className="mt-1 w-full bg-transparent text-[16px] font-medium tracking-[0.3em] text-[#111827] outline-none placeholder:text-[#c4c9d2] placeholder:tracking-normal"
                    />
                  </div>
