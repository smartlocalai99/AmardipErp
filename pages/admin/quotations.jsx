      ...
      <main className="mx-auto max-w-5xl p-4 space-y-4">
        <div className="rounded-3xl bg-[#0a649d] p-5 text-white shadow-sm">
          ...
          <div className="mt-2 flex items-center justify-between gap-3">
            ...
            {canGenerate && <button onClick={() => setShowCreate(true)} className="h-10 rounded-2xl bg-white px-4 text-xs font-black text-[#0a649d]">Create</button>}
          </div>
        </div>
        ...
        {loading ? <p className="rounded-3xl bg-white p-8 text-center text-xs font-bold text-slate-400">Loading quotations...</p> : quotations.length === 0 ? <p className="rounded-3xl bg-white p-8 text-center text-xs font-bold text-slate-400">No quotations found.</p> : (
